...
export default function BackgroundAuth () {
	return (
		<div className="w-full h-screen bg-black flex items-center justify-start overflow-hidden relative">
			<div className="bg-transparent shadow-[100px_0_450px_225px_rgba(128,128,128,0.9)] translate-x-[-50%]" />
